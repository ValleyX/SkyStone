...
public class BlackRectDetector extends DogeCVDetector {
...
//    public RatioScorer ratioScorer = new RatioScorer(1.25, 3); // Used to find the short face of the stone
    public RatioScorer ratioScorer = new RatioScorer(18, 7); // Used to find the short face of the stone
    ...
    public BlackRectDetector() {
        detectorName = "Black Rect Detector";
    }
